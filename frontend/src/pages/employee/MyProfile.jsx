...
export default function MyProfile() {
  ...
  const InfoRow = ({ label, value }) => (
    <div className="flex flex-col sm:flex-row sm:items-center py-3 border-b border-gray-50 last:border-0">
      <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider w-40 flex-shrink-0">{label}</span>
          ...
          <form onSubmit={handleSubmit(changePassword)} className="space-y-4 max-w-md">
            ...
            <div>
              ...
              <div className="relative">
                <input type={showOld ? 'text' : 'password'} {...register('currentPassword', { required: true })}
                  className="input-base pr-10" placeholder="Enter current password" />
            ...
            <div>
              ...
              <input type="password" {...register('confirm', { required: true })}
                className="input-base" placeholder="Repeat new password" />
            </div>
