  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        <h2 className="text-xl font-bold text-amber-700 mb-6">Enter New Password</h2>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-amber-600 text-white py-2.5 rounded-lg font-semibold">Reset Password</button>
        </form>
      </div>
    </div>
  );
