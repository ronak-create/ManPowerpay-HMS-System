...
import {
  LayoutDashboard, Users, Calendar, ClipboardList, LogOut, ChevronRight, Bell, Briefcase
} from 'lucide-react';
...
const navGroups = [
  ...
  },
  {
    label: 'HR',
    items: [
      { to: '/supervisor/leaves', icon: Briefcase, label: 'Leave Approvals' },
    ]
  },
];
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 bg-white border-b border-gray-100 flex items-center px-6 gap-4 flex-shrink-0 shadow-sm">
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-400">ManpowerPay HMS — Supervisor</p>
          </div>
