...
import { LayoutDashboard, Calendar, FileText, CalendarOff, User, LogOut } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/employee/leaves', icon: CalendarOff, label: 'Apply Leave' },
    ...
    <div className="flex h-screen bg-gray-100">
      <aside className="w-64 bg-primary flex flex-col">
        <div className="p-5 border-b border-white/10">
          ...
          <div className="text-white/60 text-xs mt-0.5">Employee Portal</div>
        </div>
